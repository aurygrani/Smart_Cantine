...
Pubblica ogni 10 secondi sul topic cantine/urbani/pievepelago/sensori
con valori realistici che variano leggermente ad ogni ciclo.
"""
...
client = mqtt.Client(client_id="sensore_finto")
